...
namespace IIS.Pos
{
    ...
    public class Номенклатура : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pos.ЕдиницыИзмер fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.Pos.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Pos.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НоменклатураE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураE", typeof(IIS.Pos.Номенклатура));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НоменклатураL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураL", typeof(IIS.Pos.Номенклатура));
                }
            }
        }
    }
