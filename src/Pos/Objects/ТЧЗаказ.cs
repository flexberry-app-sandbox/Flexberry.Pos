...
namespace IIS.Pos
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pos.Номенклатура fНоменклатура;
        
        private IIS.Pos.ОтчетОЗак fОтчетОЗак;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Pos.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Pos.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Pos.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Pos.ЗаказПост",
                "IIS.Pos.ОтчетОЗак"})]
        public virtual IIS.Pos.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.Pos.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Pos.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Pos.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Pos.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Pos.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.Pos.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Pos.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Pos.ТЧЗаказ dataobject)
        {
