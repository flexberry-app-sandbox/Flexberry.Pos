...
namespace IIS.Pos
{
    ...
    [View("ЗаказПостL", new string[] {
            ...
            "ДатаОкончания as \'Дата окончания\'",
            "Номер as \'Номер\'"})]
    public class ЗаказПост : IIS.Pos.ОтчетОЗак
    {
        
        private IIS.Pos.DetailArrayOfТЧЗаказ fЗаказ;
        ...
        public override IIS.Pos.СостПоставок СостОтгрузки
        {
            get
            {
                ...
                IIS.Pos.СостПоставок result = base.СостОтгрузки;
        ...
        public override IIS.Pos.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.Pos.СостОплаты result = base.СостояниеОплаты;
        ...
        [TypeUsage(typeof(IIS.Pos.Контрагенты))]
        [PropertyStorage(new string[] {
                "Контрагенты"})]
        public override IIS.Pos.Контрагенты Контрагенты
        {
            get
            {
                ...
                IIS.Pos.Контрагенты result = ((IIS.Pos.Контрагенты)(base.Контрагенты));
            ...
            set
            {
                ...
                base.Контрагенты = ((IIS.Pos.Контрагенты)(value));
        ...
        [TypeUsage(typeof(IIS.Pos.Организации))]
        [PropertyStorage(new string[] {
                "Организации"})]
        public override IIS.Pos.Организации Организации
        {
            get
            {
                ...
                IIS.Pos.Организации result = ((IIS.Pos.Организации)(base.Организации));
            ...
            set
            {
                ...
                base.Организации = ((IIS.Pos.Организации)(value));
        ...
        [TypeUsage(typeof(IIS.Pos.Склады))]
        [PropertyStorage(new string[] {
                "Склады"})]
        public override IIS.Pos.Склады Склады
        {
            get
            {
                ...
                IIS.Pos.Склады result = ((IIS.Pos.Склады)(base.Склады));
            ...
            set
            {
                ...
                base.Склады = ((IIS.Pos.Склады)(value));
        ...
        public virtual IIS.Pos.DetailArrayOfТЧЗаказ Заказ
        {
            get
            {
                ...
                if ((this.fЗаказ == null))
                {
                    this.fЗаказ = new IIS.Pos.DetailArrayOfТЧЗаказ(this);
                }
                IIS.Pos.DetailArrayOfТЧЗаказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостE", typeof(IIS.Pos.ЗаказПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостL", typeof(IIS.Pos.ЗаказПост));
                }
            }
        }
    }
