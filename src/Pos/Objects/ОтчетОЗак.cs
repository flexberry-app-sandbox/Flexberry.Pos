...
namespace IIS.Pos
{
    ...
    public class ОтчетОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pos.СостПоставок fСостОтгрузки;
        
        private IIS.Pos.СостОплаты fСостояниеОплаты;
        ...
        private IIS.Pos.DetailArrayOfТЧЗаказ fТЧЗаказ;
        ...
        public virtual IIS.Pos.СостПоставок СостОтгрузки
        {
            get
            {
                ...
                IIS.Pos.СостПоставок result = this.fСостОтгрузки;
        ...
        public virtual IIS.Pos.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.Pos.СостОплаты result = this.fСостояниеОплаты;
        ...
        public virtual IIS.Pos.DetailArrayOfТЧЗаказ ТЧЗаказ
        {
            get
            {
                ...
                {
                    this.fТЧЗаказ = new IIS.Pos.DetailArrayOfТЧЗаказ(this);
                }
                IIS.Pos.DetailArrayOfТЧЗаказ result = this.fТЧЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакE", typeof(IIS.Pos.ОтчетОЗак));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОЗакL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОЗакL", typeof(IIS.Pos.ОтчетОЗак));
                }
            }
        }
    }
