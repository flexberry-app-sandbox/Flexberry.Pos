...
namespace IIS.Pos
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pos.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Pos.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Pos.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Pos.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Pos.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Pos.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Pos.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Pos.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Pos.План this[int index]
        {
            get
            {
                return ((IIS.Pos.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Pos.План dataobject)
        {
